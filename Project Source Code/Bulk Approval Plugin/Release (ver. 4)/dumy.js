                            ...
                            selectedRecords.forEach((record, index) => {
                                ...
                                if(asigneeType == "ONE"){
                                   ...
                                   // console.log('Name of the element with the highest index:', lastStatusName);
                                    ...
                                    // console.log(currentAssigneeType);
                                    // console.log(lastIndexCheck);
                                    console.log(approval_assignee);

                                    // let statusPosition;
                                    // statusArray.push(currentStatus);
                                    // const countStatus = statusArray.filter(element => element === currentStatus).length;
                                    // console.log(countStatus);
                                    // if(countStatus == 0){
                                    //     statusPosition = 0;
                                    // }else{
                                    //     statusPosition = countStatus;
                                    // }
                                    ...
                                    if(currentAssigneeType != 'ALL' && lastIndexCheck == 0){
                                        ...
                                        console.log(foundEntry[1].assignee.entities[0].entity.code);
                                        console.log(expectedUser.value[0].code);

                                        if (approval_assignee[currentStatus][countStatus]) {
                                            //const assignee = approval_assignee[currentStatus][countStatus];
